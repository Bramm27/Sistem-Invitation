                            ...
                            <div class="row">
                                <div class="col-8 text-start">
                                    <div class="icon icon-shape bg-white shadow text-center border-radius-2xl">
                                        <i class="fa-solid fa-user text-dark text-gradient text-lg opacity-10"
                                            aria-hidden="true"></i>
                                    </div>
                                    <h5 class="text-white font-weight-bolder mb-0 mt-3">
                                        {{ $totalGuest }}
                                    </h5>
                                    <span class="text-white text-sm">Total Guest</span>
                                </div>
                                <div class="col-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-8 text-start">
                                    <div class="icon icon-shape bg-white shadow text-center border-radius-2xl">
                                        <i class="fa-solid fa-reply text-dark text-gradient text-lg opacity-10"
                                            aria-hidden="true"></i>
                                    </div>
                                    <h5 class="text-white font-weight-bolder mb-0 mt-3">
                                        {{ $totalRespons }}
                                    </h5>
                                    <span class="text-white text-sm">Respons Guest </span>
                                </div>
                                <div class="col-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-8 text-start">
                                    <div class="icon icon-shape bg-white shadow text-center border-radius-2xl">
                                        <i class="fa-solid fa-check text-dark text-gradient text-lg opacity-10"
                                            aria-hidden="true"></i>
                                    </div>
                                    <h5 class="text-white font-weight-bolder mb-0 mt-3">
                                        {{ $totalPresent }}
                                    </h5>
                                    <span class="text-white text-sm">Guest Present</span>
                                </div>
                                <div class="col-4">
                                    <div class="dropdown text-end mb-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-8 text-start">
                                    <div class="icon icon-shape bg-white shadow text-center border-radius-2xl">
                                        <i class="fa-solid fa-door-open text-dark text-gradient text-lg opacity-10"
                                            aria-hidden="true"></i>
                                    </div>
                                    <h5 class="text-white font-weight-bolder mb-0 mt-3">
                                        {{ $totalCheck }}
                                    </h5>
                                    <span class="text-white text-sm">Guest Check-in</span>
                                </div>
                                <div class="col-4">
                                    <div class="dropstart text-end mb-6">
                ...
                <div class="card-header pb-0">
                    <div class="row">
                        <div class="col-lg-6 col-7">
                            <h6 class="mb-0">Guest Present Respons</h6>
                            ...
                            <div class="bg-primary border-radius-lg h-100">
                                ...
                                <div class="position-relative d-flex align-items-center justify-content-center h-100">
                                    <img class="w-100 position-relative z-index-2 pt-4"
                                        src="{{ asset('admin') }}/assets/img/illustrations/rocket-white.png" alt="rocket">
                                </div>
                            </div>
                        </div>
                    </div>
