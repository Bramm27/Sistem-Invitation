...
--
-- Host: 127.0.0.1:3306
-- Waktu pembuatan: 26 Jan 2025 pada 12.58
-- Versi server: 8.3.0
-- Versi PHP: 8.3.3
...
INSERT INTO `guests` (`id`, `name`, `number_phone`, `company_name`, `respons`, `check_in`, `created_at`, `updated_at`) VALUES
(1, 'Bramm', 123456789, 'SMKTAG', 'Belum ada respon', 'Belum Check-In', '2025-01-16 06:46:16', '2025-01-16 06:46:16'),
(2, 'Shenly', 100407, 'SMKTAG', 'Belum ada respon', 'Belum Check-In', '2025-01-16 07:31:30', '2025-01-16 07:31:30');
...
(1, 'Star', 'star@gmail.com', NULL, '1', '$2b$12$h6DLT5HoguzDP94J.nC.M.u6pBLo3hLrYq9rM.F9TzCZLQhcEKSyq\r\n', NULL, NULL, NULL);
COMMIT;
